      ...
      <SEO
        ...
        schema={[
          ...
          },
          {
            ...
            "jobTitle": "Врач травматолог-ортопед высшей категории",
            "description": "Врач травматолог-ортопед высшей категории в Новосибирске со стажем более 20 лет. 12 лет хирургического лечения травм и заболеваний опорно-двигательного аппарата, более 8 лет консервативного безоперационного лечения. PRP-терапия, SVF-терапия, коллагенотерапия, гиалуроновая кислота, все виды блокад — внутрисуставные, параартикулярные и внутрикостные. Ортезирование: подбор бандажей, ортезов и корсетов.",
            "image": "https://vash-ortoped.ru/paliy-vasiliy.jpg",
            "worksFor": { "@type": "MedicalClinic", "name": "Ваш Ортопед", "url": "https://vash-ortoped.ru" },
            "medicalSpecialty": ["Orthopedic", "Traumatology"],
            "alumniOf": [
              { "@type": "CollegeOrUniversity", "name": "Воронежская государственная медицинская академия им. Н.Н. Бурденко" },
              { "@type": "CollegeOrUniversity", "name": "НИИТО им. Я.Л. Цивьяна" }
            ],
            "hasCredential": [
              { "@type": "EducationalOccupationalCredential", "credentialCategory": "Высшая квалификационная категория по специальности «Травматология и ортопедия»" },
              { "@type": "EducationalOccupationalCredential", "credentialCategory": "Ординатура по специальности «Травматология и ортопедия», НИИТО им. Я.Л. Цивьяна, 2014" }
            ],
            "knowsAbout": ["Лечение артроза", "Лечение артрита", "Лечение бурсита", "Лечение тендинита", "PRP-терапия", "SVF-терапия", "Коллагенотерапия", "Гиалуроновая кислота", "Внутрикостные блокады", "Внутрисуставные блокады", "Параартикулярные блокады", "Медикаментозные блокады", "Ортезирование", "Подбор ортезов и бандажей", "УЗИ суставов"],
            "url": "https://vash-ortoped.ru/doctors"
          },
          {
            "@context": "https://schema.org",
