...
const DISEASES = [
  ...
  },
  {
    ...
    desc: "Переломы и вывихи — одни из самых частых травм опорно-двигательного аппарата. Правильная и своевременная помощь определяет скорость восстановления и качество функции конечности. В нашей клинике применяется весь спектр современных методов — от консервативного лечения до малоинвазивного остеосинтеза.",
    symptoms: [
    ...
    methods: [
      ...
      "Остеосинтез — фиксация металлоконструкцией (пластина, штифт, аппарат Илизарова)",
      "Вправление вывиха под местной анестезией или наркозом",
      "Скелетное вытяжение при сложных переломах бедра и голени",
      "Блокада места перелома для обезболивания без наркоза",
      "Физиотерапия и ЛФК на этапе реабилитации",
    ],
    steps: [
      { step: "01", title: "Экстренная консультация", text: "Осмотр травматолога, оценка тяжести травмы, обезболивание." },
      { step: "02", title: "Рентгенография / КТ", text: "Уточняем характер перелома или вывиха, оцениваем смещение фрагментов." },
      { step: "03", title: "Репозиция и фиксация", text: "Вправляем вывих или сопоставляем фрагменты перелома, накладываем гипс или выполняем операцию." },
      { step: "04", title: "Реабилитация", text: "Разработка сустава, физиотерапия, восстановление силы и объёма движений." },
    ],
  },
  {
    ...
    methods: [
      ...
      "Физиотерапия: ударно-волновая терапия, электрофорез, магнитотерапия",
      "Лечебная физкультура и постуральная коррекция",
      "Тракционная терапия (вытяжение позвоночника) при необходимости",
    ],
    steps: [
      { step: "01", title: "Консультация и диагностика", text: "Оцениваем неврологический статус, назначаем МРТ позвоночника при необходимости." },
      { step: "02", title: "Купирование острой боли", text: "Паравертебральная блокада или медикаментозная терапия для снятия болевого синдрома." },
      { step: "03", title: "Восстановительное лечение", text: "Физиотерапия, PRP-терапия или введение хондропротекторов для замедления дегенерации." },
      { step: "04", title: "Профилактика рецидивов", text: "Индивидуальная программа ЛФК, рекомендации по осанке и образу жизни." },
    ],
  },
  {
    slug: "bursitis",
