...
const DISEASES = [
  {
    ...
    methods: [
      ...
      "Лечебный массаж и ЛФК — укрепление мышц вокруг сустава, назначается врачом",
    ],
    steps: [
      { step: "01", title: "Первичная консультация", text: "Ортопед проводит осмотр, собирает анамнез и определяет стадию заболевания." },
      { step: "02", title: "Лабораторная диагностика", text: "Анализы крови на маркёры воспаления, ревматоидный фактор и мочевую кислоту — точная картина состояния сустава." },
      { step: "03", title: "Индивидуальный план лечения", text: "Выбираем оптимальную тактику — PRP, гиалуроновую кислоту или блокады — с учётом стадии, возраста и образа жизни." },
      { step: "04", title: "Лечение и наблюдение", text: "Проводим курс процедур в клинике, назначаем лечебный массаж, контролируем динамику и корректируем при необходимости." },
    ],
  },
  {
    ...
    methods: [
      ...
      "Внутривенные инфузии с противовоспалительными препаратами",
      "ЛФК и растяжка — назначаются врачом после снятия воспаления",
    ],
    steps: [
      ...
      { step: "04", title: "Восстановительный курс", text: "Проводим процедуры, назначаем лечебный массаж, обучаем правильной нагрузке для профилактики рецидивов." },
    ],
  },
  {
    slug: "synovitis",
    ...
    steps: [
      ...
      { step: "04", title: "Восстановление", text: "Назначаем лечебный массаж, восстанавливаем тонус мышц и разрабатываем сустав для предотвращения рецидива." },
    ],
  },
  {
    ...
    desc: "Переломы и вывихи — одни из самых частых травм опорно-двигательного аппарата. Правильная и своевременная помощь определяет скорость восстановления и качество функции конечности. В нашей клинике применяется весь спектр консервативных методов лечения переломов и вывихов.",
    symptoms: [
      "Резкая боль в месте травмы, усиливающаяся при движении",
      "Отёк и гематома мягких тканей",
      "Деформация конечности или сустава",
      "Патологическая подвижность или, наоборот, полная блокада сустава",
      "Крепитация (хруст) при пальпации в месте перелома",
      "Онемение или слабость дистальных отделов конечности",
    ],
    methods: [
      "Закрытая репозиция перелома и иммобилизация гипсом или лонгетой",
      "Вправление вывиха под местной анестезией",
      "Блокада места перелома для обезболивания",
      "Внутривенные инфузии с обезболивающими и противовоспалительными препаратами",
      "ЛФК и лечебный массаж — назначаются врачом после консолидации",
    ],
    steps: [
      { step: "01", title: "Экстренная консультация", text: "Осмотр травматолога, оценка тяжести травмы, обезболивание." },
      { step: "02", title: "Диагностика", text: "Направляем на рентгенографию для уточнения характера перелома или вывиха и оценки смещения фрагментов." },
      { step: "03", title: "Репозиция и фиксация", text: "Вправляем вывих или сопоставляем фрагменты перелома, накладываем гипс или лонгету." },
      { step: "04", title: "Восстановление", text: "Врач составляет программу восстановления: ЛФК, лечебный массаж, контроль сращения." },
    ],
  },
  {
    slug: "osteochondrosis-back-pain",
    title: "Остеохондроз и боль в спине",
    img: "https://cdn.poehali.dev/projects/6e339ebb-3990-4eb0-b0e9-b0325ebc1901/bucket/5e7bc39d-36e2-4ecb-9def-1086449b0f96.jpeg",
    desc: "Остеохондроз и боль в спине — глобальная проблема: до 80% людей хотя бы раз в жизни испытывают выраженную боль в позвоночнике. Дегенеративные изменения межпозвонковых дисков ведут к протрузиям, грыжам и корешковому синдрому. Современные методы позволяют устранить боль и избежать операции.",
    symptoms: [
      "Хроническая или острая боль в шейном, грудном или поясничном отделе",
      "Прострел (люмбаго) — резкая боль в пояснице при движении",
      "Иррадиация боли в ногу или руку (корешковый синдром)",
    ...
    methods: [
      "Паравертебральные блокады — быстрое снятие острой боли",
      "PRP-терапия — восстановление тканей межпозвонкового диска",
      "Медикаментозное лечение: НПВС, миорелаксанты, витамины группы В",
      "Ударно-волновая терапия — назначается врачом при хроническом болевом синдроме",
      "Лечебная физкультура и постуральная коррекция — индивидуальная программа",
      "Внутривенные инфузии с хондропротекторами и противовоспалительными препаратами",
    ],
    steps: [
      { step: "01", title: "Консультация и диагностика", text: "Оцениваем неврологический статус, при необходимости направляем на лабораторные анализы и инструментальную диагностику." },
      { step: "02", title: "Купирование острой боли", text: "Паравертебральная блокада или внутривенная инфузионная терапия для быстрого снятия болевого синдрома." },
      { step: "03", title: "Восстановительное лечение", text: "PRP-терапия или капельницы с хондропротекторами для замедления дегенерации диска." },
      { step: "04", title: "Профилактика рецидивов", text: "Индивидуальная программа ЛФК, лечебный массаж, рекомендации по осанке и образу жизни." },
    ],
  },
  {
    slug: "bursitis",
    ...
    methods: [
      ...
      "Внутривенные инфузии — ускорение рассасывания экссудата",
    ...
    steps: [
      ...
      { step: "04", title: "Восстановление", text: "Назначаем лечебный массаж и даём рекомендации по профилактике повторных обострений." },
    ],
  },
];
