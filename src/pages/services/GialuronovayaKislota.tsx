...
const BOOKING_URL = "https://booking.medflex.ru/?user=331eaa0fb0b7b75fcc25b457b8454089&utm_source=site&utm_medium=organic&utm_campaign=gialuronovaya-kislota";
  ...
  return (
    <>
      <SEO
        ...
        description="Уколы гиалуроновой кислоты в сустав в Новосибирске. Лечение артроза коленного, тазобедренного, плечевого сустава без операции. От 7800₽. Эффект до 12 месяцев. Первичный приём + УЗИ — 2800₽."
      ...
      <section className="py-12 bg-white">
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {[
              { title: "Первичный приём + УЗИ", price: "2 800 ₽", desc: "Осмотр врача-ортопеда, УЗИ сустава, постановка диагноза, план лечения", badge: "Старт" },
