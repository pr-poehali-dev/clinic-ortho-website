          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <p className="text-clinic-text-muted leading-relaxed">
                В клинике «Ваш Ортопед» в Новосибирске массаж проводится в составе комплексного лечения — в сочетании с физиотерапией, инъекционными методиками и рекомендациями ортопеда. Это позволяет добиться устойчивого результата.
              </p>
            </div>
            ...
            <div className="bg-clinic-teal-light rounded-2xl p-6">
              ...
              <p className="text-sm text-clinic-text-muted leading-relaxed">
                Массаж назначается врачом-ортопедом после осмотра. Специалист определяет зоны воздействия, интенсивность и количество сеансов в зависимости от диагноза. Как правило, курс составляет 8–10 сеансов. Первый результат ощущается уже после 3–4 процедур.
              </p>
            </div>
          </div>
