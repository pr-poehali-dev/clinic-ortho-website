  ...
  return (
    <>
      <SEO
        ...
        description="PRP-терапия (плазмотерапия, плазмолифтинг) суставов в Новосибирске. Лечение артроза, боли в колене, тазобедренном и плечевом суставе инъекциями собственной плазмы. От 4000₽ за процедуру. Первичный приём + УЗИ — 2800₽."
