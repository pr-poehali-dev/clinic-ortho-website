...
const promos = [
  {
    ...
    description: "Предъявите пенсионное удостоверение — скидка 20% на консультацию.",
    promo: null,
  },
  {
    id: 2,
    ...
    bg: "#fdf6f0",
    border: "#e07a2f",
    title: "Курс PRP-терапии",
    subtitle: "1 инъекция в подарок из 4",
    description: "Оплатите курс из 4 инъекций сразу — одна в подарок.",
    promo: null,
  },
  {
    id: 3,
    ...
    subtitle: "Быстро, без очередей",
    description: "Широкий спектр исследований крови и мочи. Недорого.",
    promo: null,
  },
  {
    id: 4,
    ...
    description: "Скидка на приём врача и PRP-плазмотерапию при артрозе.",
    promo: "Ортопед Нск",
  },
  {
    id: 5,
    ...
    description: "Скидка на первичный приём при грыже или протрузии диска.",
    promo: "Ваш невролог",
  },
  {
    id: 6,
    ...
    subtitle: "Курс 10 процедур",
    description: "Скидка на курс из 10 сеансов при единовременной оплате.",
    promo: "Ортомассаж",
  },
];
