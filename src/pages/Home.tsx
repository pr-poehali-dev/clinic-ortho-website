            ...
            <div className="mt-7 animate-fade-in-up-delay-2">
              ...
              <div className="flex flex-row gap-2">
                {[
                  ...
                  <div key={label} className="flex items-center gap-3 bg-white/80 border border-clinic-teal/15 rounded-xl py-3 px-5 shadow-sm">
                    <Icon name={icon} size={22} className="text-clinic-teal shrink-0" />
                    <span className="text-base font-semibold text-clinic-text">{label}</span>
                  </div>
                ))}
              </div>
            </div>
