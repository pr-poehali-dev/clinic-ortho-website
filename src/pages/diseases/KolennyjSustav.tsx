...
const BOOKING_URL = "https://booking.medflex.ru/?user=331eaa0fb0b7b75fcc25b457b8454089&utm_source=site&utm_medium=organic&utm_campaign=kolennyj-sustav";
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Первичный приём с УЗИ сустава — 2 800 ₽. Стоимость лечения зависит от метода и стадии: PRP — от 4 000 ₽ за процедуру, гиалуроновая кислота — от 7 800 ₽, блокады — от 2 500 ₽. Точную цену рассчитаем на приёме.",
  },
  {
  ...
  return (
    <>
      <SEO
        ...
        description="Лечение боли в коленном суставе в Новосибирске без операции. Гонартроз, бурсит, синовит, менисковые боли. PRP-терапия от 4000₽, гиалуроновая кислота от 7800₽, блокады от 2500₽. Первичный приём + УЗИ — 2800₽."
