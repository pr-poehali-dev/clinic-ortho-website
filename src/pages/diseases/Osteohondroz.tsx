...
const STEPS = [
  {
    ...
    desc: `Первый и ключевой этап лечения остеохондроза — быстрое и эффективное устранение болевого синдрома и воспаления. Врач-ортопед вводит лекарственные препараты (анестетик + противовоспалительное) непосредственно в паравертебральную зону — ткани, окружающие позвоночник.`,
    details: [
      ...
      <section className="container py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {[
              { icon: "UserCheck", title: "Опытный врач-ортопед", desc: "Личный приём у травматолога-ортопеда с многолетним опытом лечения заболеваний позвоночника" },
