...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Первичный приём с УЗИ сустава — 2 800 ₽. PRP-терапия — от 4 000 ₽ за процедуру, гиалуроновая кислота — от 7 800 ₽, блокады — от 2 500 ₽. Точную стоимость рассчитаем после осмотра.",
  },
  {
  ...
  return (
    <>
      <SEO
        ...
        description="Лечение тазобедренного сустава в Новосибирске без операции. Коксартроз, бурсит, синовит. PRP-терапия от 4000₽, гиалуроновая кислота от 7800₽, SVF-терапия, блокады от 2500₽. Первичный приём + УЗИ — 2800₽."
