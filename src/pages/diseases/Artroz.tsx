...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Стоимость зависит от выбранного метода и стадии заболевания. Первичная консультация — 2 800 ₽, включает осмотр и УЗИ сустава. Конкретный план и цену рассчитаем на приёме.",
  },
  {
  ...
  return (
    <>
      <SEO
        ...
        description="Лечение артроза коленного, тазобедренного, плечевого сустава в Новосибирске без операции. PRP-терапия от 4000₽, SVF-терапия, гиалуроновая кислота от 7800₽, блокады от 2500₽. Первичный приём + УЗИ — 2800₽. Запись онлайн."
          ...
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 bg-amber-50 border border-amber-200 rounded-2xl px-6 py-4 shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className="text-base font-bold text-clinic-text block">Первичный приём + УЗИ сустава — 2 800 ₽</span>
      ...
      <section className="py-12 bg-white">
        <div className="container">
          ...
          <div className="flex flex-col gap-0">
            {[
              { step: "01", title: "Запись и первичный приём", desc: "Консультация травматолога-ортопеда + УЗИ сустава прямо на приёме. Ставим точный диагноз, определяем стадию. Стоимость — 2 800 ₽." },
      ...
      <section className="py-10 bg-clinic-warm border-y border-clinic-beige-dark/30">
        <div className="container text-center">
          ...
          <p className="text-clinic-text-muted mb-6 max-w-md mx-auto">
            Консультация + УЗИ сустава — 2 800 ₽. Приём сегодня, без очереди.
          </p>
