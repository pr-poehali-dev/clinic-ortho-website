...
const PRICE_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Внутрикостная блокада дексаметазон 4мг, лидокаин 2% 2мг, вода д/инъекций 4мл", price: "7 000" },
    ],
  },
  {
    title: "PRP-терапия",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Изготовление индивидуальных каркасных стелек‑супинаторов с консультацией (формовка + рекомендации)", price: "4 800" },
