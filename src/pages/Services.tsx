...
export default function Services() {
  ...
  return (
    <>
      <SEO
        title="Услуги клиники — ортопедия, травматология, блокады"
        description="Ортопедия, травматология, блокады, инъекции гиалуроновой кислоты, PRP-терапия, анализы в клинике «Ваш Ортопед», Новосибирск. Запись: +7 999 464 91 94."
        canonical="/services"
        ...
        <div className="container">
          <div className="max-w-xl">
            ...
            <p className="text-clinic-text-muted leading-relaxed">
              Ортопедия, травматология, неврология, ударно-волновая и SVF-терапия, блокады и инъекции, лабораторные анализы и внутривенные инфузии — всё в одной клинике. Выберите направление, чтобы узнать подробнее.
            </p>
          </div>
        </div>
      </section>
