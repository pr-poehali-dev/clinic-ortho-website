...
const DISEASE_LINKS = [
  ...
  { href: "/services/svf", label: "SVF-терапия суставов" },
];
      ...
      <header className="bg-white border-b border-border sticky top-0 z-50 shadow-sm">
        <div className="container flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex flex-col items-center">
            ...
            />
            <span className="text-[11px] font-body tracking-[0.18em] uppercase leading-none mt-0.5 ml-2 whitespace-nowrap text-clinic-text-muted">Клиника лечения суставов</span>
          </Link>
